        ...
        <section className="rounded-2xl overflow-hidden bg-gradient-to-br from-[#4a875b] to-[#34603f] text-white p-5">
          ...
          {firstUnfinished ? (
            <Link
              ...
              className="block rounded-xl bg-[#fffdf8] text-[#34603f] py-3 px-4 text-sm font-bold text-center shadow-[0_4px_0_rgba(0,77,64,0.5)] hover:bg-[#e0d5be] transition-colors"
            >
