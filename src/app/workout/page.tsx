      ...
      <div className="mx-auto max-w-2xl px-4 py-6">
        <div className="bg-white border border-[#e8ebe9] rounded-2xl overflow-hidden">
          ...
          <div className="px-4 py-6 text-center bg-gradient-to-br from-[#e0f2f1] to-[#fffbe6] border-b border-[#e8ebe9]">
            ...
            <div className="text-base font-bold text-zinc-900 mb-2 leading-relaxed">
              のりfitness があなたの
              <br />
              カルテを確認しています
            </div>
          ...
          <div className="p-4 space-y-3">
            <div className="bg-[#fafafa] border border-[#e8ebe9] rounded-lg p-4">
              <div className="text-[11px] font-bold text-zinc-500 tracking-wide mb-3">
                提出したカルテ
              </div>
              <dl className="grid grid-cols-[80px_1fr] gap-y-1.5 gap-x-3 text-xs">
                ...
                <dt className="text-zinc-500 text-[11px]">重点部位</dt>
                <dd className="text-zinc-900 font-semibold">
              ...
              <Link
                href="/workout/carte"
                className="block text-center text-[11px] text-[#00695c] font-bold border-t border-[#e8ebe9] mt-3 pt-3"
              >
                カルテを見る →
              </Link>
            </div>
          ...
          <div className="bg-white border-t border-[#e8ebe9] px-4 py-3">
            <button
              disabled
              className="w-full px-4 py-3 bg-zinc-100 text-zinc-400 rounded-2xl text-sm font-bold cursor-not-allowed"
            >
              メニューはまだありません
            </button>
          </div>
