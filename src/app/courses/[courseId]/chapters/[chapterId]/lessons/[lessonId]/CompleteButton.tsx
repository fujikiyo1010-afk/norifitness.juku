  ...
  return (
    <div className="space-y-2">
      <button
        ...
        onClick={handleToggle}
        disabled={pending}
        className="w-full rounded-lg bg-zinc-900 dark:bg-[#f3ecda] px-6 py-4 text-base font-semibold text-white dark:text-[#2b2620] disabled:opacity-50 transition-transform active:scale-[0.98]"
      >
        {pending ? "保存中…" : "✓ 学習完了にする"}
      </button>
      {error && (
