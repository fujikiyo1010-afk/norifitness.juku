      ...
      <div className="px-4 pt-5 pb-8 space-y-5">
              ...
              <button
                ...
                className={`w-full text-left flex items-center gap-3 rounded-2xl px-4 py-3 border transition-colors ${
                  selected
                    ...
                    : "bg-[#fffdf8] border-[#e7dcc9] hover:bg-[#e0d5be]"
                }`}
              >
                <span
        ...
        <div className="flex gap-2 pt-3">
          <button
            ...
            className="flex-1 bg-[#fffdf8] border border-[#e7dcc9] rounded-2xl px-4 py-3 text-[13px] font-bold text-zinc-700 hover:bg-[#e0d5be] transition-colors disabled:opacity-40"
          >
            ← 前へ
          </button>
          {isLast ? (
    ...
    <div className="px-4 pt-5 pb-8 space-y-5">
      ...
      <div className="flex gap-2 pt-3">
        <button
          type="button"
          onClick={onRetry}
          className="flex-1 bg-[#fffdf8] border border-[#e7dcc9] rounded-2xl px-4 py-3 text-[13px] font-bold text-zinc-700 hover:bg-[#e0d5be] transition-colors"
        >
          もう一度 受ける
        </button>
        <button
