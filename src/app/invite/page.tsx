  ...
  return (
    <main className="flex flex-1 flex-col items-center justify-center p-6">
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="rounded-md border border-zinc-200 dark:border-zinc-800 bg-[#f9f5ed] dark:bg-zinc-900 p-4 text-sm space-y-1">
    ...
    <main className="flex flex-1 flex-col items-center justify-center p-6">
      <div className="w-full max-w-md space-y-4 text-center">
        ...
        {showLoginLink && (
          <a
            href="/login"
            className="inline-block rounded-md bg-zinc-900 dark:bg-[#f9f5ed] px-4 py-2 text-sm font-medium text-white dark:text-[#2b2620]"
          >
            ログイン画面へ
          </a>
        )}
