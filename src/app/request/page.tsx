      ...
      <div className="mx-auto w-full max-w-[460px] flex flex-1 flex-col border-x border-[#e8ebe9] bg-white">
        ...
        >
          <div className="text-center mb-6">
            <div className="w-[60px] h-[60px] mx-auto mb-3 rounded-2xl flex items-center justify-center bg-[#00897b]/8">
              <DocIcon />
            </div>
          ...
          <div className="mt-3.5 bg-[#00897b]/[0.06] border-l-[3px] border-[#00897b] rounded-sm px-3 py-2.5 text-[11px] text-zinc-700 leading-relaxed">
            申請後、 のりfitness が内容を確認 (通常 1 営業日以内)、 確認完了後にメールでアカウント有効化リンクをお送りします。
          </div>

          <div className="mt-3 text-center text-[10.5px] text-zinc-500 leading-relaxed">
            個別面談がお済みでない方は、 まず{" "}
            <span className="text-[#00695c] font-medium">公式 LINE</span>
            までご連絡ください。
          </div>
        </div>
      </div>
...
function RequestComplete() {
  return (
    <main className="flex flex-1 flex-col bg-zinc-50 min-h-screen">
      <div className="mx-auto w-full max-w-[460px] flex flex-1 flex-col border-x border-[#e8ebe9] bg-white">
        <header className="px-4 py-3 border-b border-[#e8ebe9] text-center">
          <h1 className="text-[15px] font-bold text-zinc-900">申請完了</h1>
        </header>
        ...
        <div
          ...
          style={{ background: "linear-gradient(135deg, #e0f2f1, #fffbe6)" }}
        >
          <div className="w-[80px] h-[80px] mb-5 rounded-full bg-[#00897b]/10 flex items-center justify-center">
            <CheckIcon />
          </div>
          ...
          <div className="bg-white border border-[#e8ebe9] rounded-lg px-4 py-3 text-xs text-zinc-600 leading-relaxed">
          ...
          <Link
            href="/login"
            className="mt-8 text-xs text-[#00695c] underline hover:text-[#004d40]"
          >
            ログイン画面へ
          </Link>
        </div>
