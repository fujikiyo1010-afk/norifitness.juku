...
// 色・略称はクライアント安全な part-color に分離(2026-07-29)。ここで再exportし既存の
// import 元(@/lib/workout/weekly)を維持しつつ、MenuView 等クライアントは part-color を直接 import する。
import { menuAbbr, targetColor } from "@/lib/workout/part-color";
import type { DistKind } from "@/lib/workout/part-color";
export { menuAbbr, targetColor };
